// lib/screens/papers/nts_paper_screen.dart
...
// ─── Booklet enum ─────────────────────────────────────────────────────────────
// examBg  = solid dark color used as background during the exam
// accent  = color for progress bars, dots, borders, question numbers
...
class _NtsPaperScreenState extends ConsumerState<NtsPaperScreen> {
  ...
  // Only shown once the exam has started (_bookletConfirmed == true).
  // On the booklet selection page, back works normally.
  ...
  Widget build(BuildContext context) {
    ...
    // canPop: true here so the back button works normally on this page.
    ...
    // ── Exam page ──────────────────────────────────────────────────────────
    // canPop: false so back button shows quit dialog instead of leaving.
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    padding: const EdgeInsets.all(14),
                    child: Column(
                      children: List.generate(pageQuestions.length, (pi) {
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            // Wrap gives us a true 2-column layout where each
                            // cell height is driven by its content, so long
                            // answers wrap naturally instead of being clipped.
                            LayoutBuilder(
                              builder: (context, constraints) {
                                ...
                                return Wrap(
                                  ...
                                  children: List.generate(q.options.length, (
                                    ...
                                    final isSel = answer?.selectedIndex == i;
                                    return GestureDetector(
                                      onTap: () => ref
                ...
                children: [
                  _NavArrow(
                    ...
                    onTap: pageIndex > 0
                        ? () => ref
                              .read(paperSessionProvider.notifier)
                              .jumpToPage(pageIndex - 1, _kQuestionsPerPage)
                        : null,
                  ),
                  Text(
                    'Swipe to turn page',
